...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\ArtisanU\public\storage' => 'string',
...
'filesystems.links.D:\\windows\\my_projects\\ArtisanU\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'telescope','dashboard','profile.edit','profile.update','profile.destroy',
...
'logout','admin.register','admin.','admin.login','admin.',
'admin.password.request','admin.password.email','admin.password.reset','admin.password.store','admin.verification.notice',
'admin.verification.verify','admin.verification.send','admin.password.confirm','admin.','admin.password.update',
'admin.logout','storage.local',);
...
'admin.auth.verify-email','admin.dashboard','auth.confirm-password','auth.forgot-password','auth.login',
...
'components.text-input','dashboard','layouts.admin','layouts.admin-navigation','layouts.app',
